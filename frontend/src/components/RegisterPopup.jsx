...
const RegisterPopup = ({ show, setShow, action }) => {
  ...
  const validate = () => {
    ...
    if (!formData.nombreCompleto.trim()) {
      ...
      formData.nombreCompleto.length < 15 ||
      formData.nombreCompleto.length > 50
    ) {
      newErrors.nombreCompleto =
        "El nombre completo debe tener entre 15 y 50 caracteres.";
    }
    ...
    if (!formData.email.trim()) {
      ...
      newErrors.email =
        "El correo electrónico debe tener entre 15 y 35 caracteres.";
    }
    ...
    try {
      ...
      if (response.status === "Success") {
        ...
        if (response.details?.email)
          setErrors({ email: response.details.email });
    ...
    <div className="bg">
      <div className="prov-popup dark:bg-[#2e2c2f] mt-20 h-570 ">
        ...
        <div className="form">
          ...
          <div className="container_inputs-rol ">
