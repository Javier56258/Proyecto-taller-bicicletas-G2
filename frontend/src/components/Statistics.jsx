...
const Statistics = () => {
    ...
    useEffect(() => {
        async function fetchStatistics() {
            ...
            totalGanancias ? setEarnings(formatter.format(totalGanancias)):         
            setEarnings(0);
      }
        fetchStatistics();
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <StatisticCard title="Productos con más stock" className="bg-green-100 dark:bg-green-900">
              ...
              <StatisticCard title="Cantidad de Productos por Proveedor " className="bg-green-100 dark:bg-green-900 options">
                <div className="overflow-x-auto rounded-lg shadow-lg">
                  <PieChart
              ...
              <StatisticCard title="Proveedores con más productos vendidos" className="bg-blue-100 dark:bg-blue-900">
                <div className="overflow-x-auto rounded-lg shadow-lg">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 bg-blue-50 dark:bg-blue-800">
                        <thead className="bg-blue-200 dark:bg-blue-700">
                            <tr>
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400 rounded-tl-lg">
                                    Proveedor
                                </th>
                                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400 rounded-tr-lg">
                                    Total Ventas
                                </th>
                            </tr>
                        </thead>
                        <tbody className="bg-blue-50 dark:bg-blue-800 divide-y divide-gray-200 dark:divide-gray-700 rounded-b-lg">
                            {mostSoldProductsProveedores.map((proveedor, index) => (
                                <tr key={proveedor.idProveedor} className={index === mostSoldProductsProveedores.length - 1 ? "rounded-b-lg" : ""}>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                                        {proveedor.nombreProveedor}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                ...
                <div className="mt-4">
                    <label htmlFor="limitMostSoldProducts" className="block text-sm font-medium text-gray-700 dark:invert">
              ...
              <StatisticCard title="Productos más vendidos" className="bg-green-100 dark:bg-green-900">
                <div className="overflow-x-auto rounded-lg shadow-lg">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 bg-green-50 dark:bg-green-800">
                        <thead className="bg-green-200 dark:bg-green-700">
                            <tr>
                        ...
                        <tbody className="bg-green-50 dark:bg-green-800 divide-y divide-gray-200 dark:divide-gray-700 rounded-b-lg">
                            {mostSoldProducts.map((producto, index) => (
                                <tr key={producto.idProducto} className={index === mostSoldProducts.length - 1 ? "rounded-b-lg" : ""}>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
            ...
            <StatisticCard title="Ganancias en intervalos de fechas" className="bg-yellow-100 dark:bg-yellow-900">
                <div className="mt-4">
                    <label htmlFor="startDate" className="block text-sm font-medium text-gray-700 dark:invert">
                        Fecha de inicio:
                    </label>
                    <input
                        type="date"
                ...
                <div className="mt-4">
                    <label htmlFor="endDate" className="block text-sm font-medium text-gray-700 dark:invert">
                        Fecha de fin:
                    </label>
                    <input
                        type="date"
