      ...
      {show && (
        <div className="bg">
          <div
            ...
            style={{ width: "460px", padding: "2rem" }}
          >
            <button className="close" onClick={() => setShow(false)}>
              <img src={CloseIcon} />
            </button>
            <h1
              className="text-3xl font-extrabold text-center text-[#475B63] dark:text-[#F3E8EE]"
              style={{
                marginTop: "30px",
                marginBottom: "20px",
              }}
            ...
            <form onSubmit={handleSubmit}>
              <div className="home-form-columns w-full flex-col">
                <div>
                  <label className="text-[#475B63] dark:text-[#F3E8EE]">
                    Nombre completo
                  </label>
                  <input
                    type="text"
