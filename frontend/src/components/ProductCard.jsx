  ...
  return (
    <div className="bg-slate-50  border border-[#729B79]  shadow-md rounded-lg p-4 dark:bg-[#2e2c2f]  dark:text-[#F3E8EE]">
      <div className="  border-gray-300 dark:border-[#F3E8EE]">
        ...
        <p>
          <span className="font-bold dark:text-[#F3E8EE]">Stock:</span>{" "}
          {product.stock}
        </p>
        <p>
          <span className="font-bold dark:text-[#F3E8EE]">Precio:</span>{" "}
        ...
        <div className="flex space-x-1 items-center ">
          ...
          <div className="">
            <input
              required
              className="size-10 m-3 border rounded dark:text-white bg-white dark:bg-[#1f1f1f]"
              type="number"
              value={cantidad}
            ...
            <button
              ...
              className="text-white bg-[#bacdb0] border-2 border-[#bacdb0] group my-4 p-2 white rounded-md hover:bg-[#fff] hover:text-[#475B63] dark:hover:bg-[#2e2c2f]    transition"
            >
              Vender
            </button>
          </div>
