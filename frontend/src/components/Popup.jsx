...
// Validación del nombre completo
    ...
    newErrors.nombreCompleto = 'El nombre debe tener entre 15 y 50 caracteres.';
  } else if (!/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/.test(nombreCompleto)) {
    newErrors.nombreCompleto = 'El nombre debe contener solo letras y espacios.';
  }
  ...
  if (newPassword && (newPassword.length < 8 || newPassword.length > 26 || !/^[a-zA-Z0-9]+$/.test(newPassword))) {
    newErrors.newPassword = 'La nueva contraseña debe tener entre 8 y 26 caracteres y contener solo letras y números.';
  }
        ...
        <div className="form-container">
          <form onSubmit={handleSubmit} className="form">
            ...
            <div className="button-containerForm">
              <button type="submit" className="button-save dark:bg-[#5f5ac4] dark:text-[#fff]">
                Editar Usuario
              </button>
              <button
                type="button"
